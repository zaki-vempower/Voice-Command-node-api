...
const reqs = require('./carbon-inkwell-342913-4349f1ecc0ac.json')
...
function speechFunction(result) {
    ...
    // Creates a client
    const client = new speech.SpeechClient(reqs);
    ...
    .on('data', data =>{
        ...
        if(data.results[0] && data.results[0].alternatives[0]){
            result(null,data.results[0].alternatives[0].transcript)
        }
